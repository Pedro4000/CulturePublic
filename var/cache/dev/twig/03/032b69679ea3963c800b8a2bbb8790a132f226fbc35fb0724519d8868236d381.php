...
class __TwigTemplate_dfd7dae73c9f22cf9f988cba194006f61caabc7ff80d7fe07d096b58ed1b9352 extends Template
{
    private $source;
    private $macros = [];
    ...
    <input type=\"email\" value=\"";
        ...
        echo "\" name=\"emailAddress\" id=\"inputEmailAddress\" class=\"form-control\" required autofocus>
...
<form method=\"post\">
    ...
    <h1 class=\"h3 mb-3 font-weight-normal\">Please sign in</h1>
    <label for=\"inputEmailAddress\">Email Address</label>
    <input type=\"email\" value=\"{{ last_username }}\" name=\"emailAddress\" id=\"inputEmailAddress\" class=\"form-control\" required autofocus>
    <label for=\"inputPassword\">Password</label>
    <input type=\"password\" name=\"password\" id=\"inputPassword\" class=\"form-control\" required>
